...
from modules.models import QuizAttempt
...
# Signal to automatically create or update a Grade when a QuizAttempt is completed
from django.db.models.signals import post_save
from django.dispatch import receiver

@receiver(post_save, sender=QuizAttempt)
def update_grade_for_quiz_attempt(sender, instance, **kwargs):
    if instance.is_completed and instance.score is not None:
        # Find the corresponding Assessment for this Quiz
        ...
        if assessment:
            ...
            percentage = (instance.score / instance.quiz.total_points) * 100
            # Determine grade letter (example logic)
            if percentage >= 90:
                grade_letter = 'A'
            elif percentage >= 80:
                grade_letter = 'B'
